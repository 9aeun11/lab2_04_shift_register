...
HD_PWD='C:/Users/gaeun/Desktop/lab2_04_shift_register/vivado/lab2_shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_shift_register.tcl -notrace
